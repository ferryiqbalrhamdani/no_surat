...
<head>
    ...
    <style>
        ...
        .card-dashboard-hover:hover {
            --bs-card-cap-bg: rgba(0, 0, 0, 0.09);
        }
...
<body class="sb-nav-fixed" style="background: #F6F9FF">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">No Surat</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link @if(request()->route()->uri == '/') active @endif"
                            onclick="functionDashboard()" style="cursor: pointer">
    ...
    <script src="{{asset('vendor/sb-admin-2/assets/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('vendor/sb-admin-2/assets/demo/chart-bar-demo.js')}}"></script>
